...
| `toggle_team_member_admin` | write | `POST /teams/{id}/members/{username}/admin` |
...
| `remove_team_member` | delete | `DELETE /teams/{id}/members/{username}` |
...
The compose file pins **Vikunja `2.6.0`** (bump deliberately, not `:latest`, so
